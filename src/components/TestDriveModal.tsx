          ...
          <div>
            ...
            <div className="relative">
              <select
                ...
                className="w-full h-10 sm:h-9 pl-3 pr-10 appearance-none rounded-control border border-line bg-paper text-base sm:text-xs text-ink focus:ring-1 focus:ring-cobalt focus:outline-none cursor-pointer"
              >
                {DEMO_FLEET.map((u) => (
